...
<!-- Mirrored from slimhamdi.net/bayya/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Aug 2018 23:28:03 GMT -->
<head>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="main-logo col-xs-12 col-md-3 col-md-2 col-lg-2 hidden-xs">
                    <a href="index.php">
                        <img id="logo" class="img-responsive" src="assets/images/logo-dark.png" alt="logo">
                    </a>
                </div>
                <!-- Logo Ends -->
                <!-- Statistics Starts -->
            ...
            <div class="container">
                <div class="site-nav-inner">
                    ...
                    <a class="logo-mobile" href="index.php">
                        <img id="logo-mobile" class="img-responsive" src="assets/images/logo-dark.png" alt="">
                    </a>
