                            ...
                            <form style={{maxWidth: '800px'}}>
                                ...
                                <div className="form-group">
                                    <div className="col-md-12">
                                        {/*<select id="usercategory" required="" name="usercategory" className="form-control" placeholder="Sex*">*/}
                                            <select id="usercategory" value={this.state.usercategory} className="form-control" name="usercategory"  onChange={(event) => this.handleUserInput(event)}>
                                            <option value=""> --Select Package-- </option>
                                            <option value="1"> BASIC $1000 &nbsp; AT 2.15% DAILY ROI</option>
                                            <option value="2"> STANDARD $2000 &nbsp; AT 5% DAILY ROI</option>
                                            <option value="3"> ADVANCE $5000 &nbsp; AT 7% DAILY ROI</option>
                                            <option value="4"> PREMIUM $10,000 &nbsp; AT 8.8% DAILY ROI</option>
                                            <option value="5"> ULTIMATE $15,000 &nbsp; AT 10.01% DAILY ROI</option>
                                            <option value="6"> GOLD $20,000 &nbsp; AT 15.15% DAILY ROI</option>
                                ...
                                <div className="row text-center">
                                    <p className="action-btn"><a className="btn btn-primary" onClick={this.formSubmitted }>Register Now</a></p>
                                </div>
