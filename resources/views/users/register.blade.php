...
@section('content')
            ...
            <div class="form-container" >
                <div>
                    ...
                    <div class="row text-center">
                        ...
                        {!! Form::open(array('route' => 'registration.post', 'files' => true, 'style'=>"max-width: 800px" )) !!}
    ...
    <script>
        ...
        function formSubmitted(){
            ...
            let usercategory = document.getElementById("usercategory").value;
           ...
           let form = new FormData();
            ...
            form.append("usercategory_id", usercategory);
