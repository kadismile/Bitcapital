                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse7">
                                        How BitechCapital generates profits for participating private investors??</a>
                                </h4>
                            </div>
                            <!-- Panel Heading Ends -->
                            <!-- Panel Content Starts -->
                            <div id="collapse7" class="panel-collapse collapse">
                                <div class="panel-body">
                                    BitechCapital engages mostly in cryptocurrencies trading, and mining,
                                    as well as FOREX. In all cases we are utilizing our proprietary Micro-Hedging
                                    (™) technology and in house developed trading algorithms.
                                </div>
                            </div>
                            <!-- Panel Content Starts -->
                        </div>
